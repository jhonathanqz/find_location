...
import 'package:find_location/src/shared/global/button/button_primary.dart';
...
import 'package:find_location/src/view/cidade/widgets/city_card.dart';
                ...
                children: [
                  ...
                  ButtonPrimary(
                    onTap: () async {
                      ...
                      await _controller.searchCEP(context);
                  ...
                  _controller.cidade != null
                      ? CityCard(cidade: _controller.cidade!)
                      : Container(),
                ],
              ),
            ),
